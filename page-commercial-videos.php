...
?>
	...
	<main id="primary" class="site-main">
		<div class="container">
			...
			<section class="animated-types">
				<h2><?php the_field('types_of_animated_title'); ?></h2>

				<?php
					$animated_types = get_field('types_of_animated_repeater');
					echo '<div class="animated-types__items">';
					foreach( $animated_types as $item ) {
					?>
					<div class="animated-types__item">
						<?php
						$animated_types_img = $item['animated_block_image'];
						if( !empty($animated_types_img) ): ?>
							<img src="<?php echo $animated_types_img['url']; ?>" alt="<?php echo $animated_types_img['alt']; ?>" />
						<?php endif; ?>
						<h3><?= $item['animated_block_title'] ?></h3>
						<p><?= $item['animated_block_description'] ?></p>
					</div>
					<?php
					}
					echo '</div>';
